...
public class SurvivorBird extends ApplicationAdapter {
	...
	public void render () {
		...
		if(gameState==1) { //oyun basladıysa
			...
			if(Gdx.input.justTouched()){//oyun basladıktan sonra ekrana tıklanılırsa kuşun yukarı cıkması ıcın her tıklayısta
				velocity=-7;//kusun tıklandıkca ucma hızı
			}
			...
			if(birdY>0) {
				velocity = velocity+gravity;//ne kadar yukardaysa asagı dogru ınerken o kadar hız kazanıyor
				birdY = birdY-velocity;//kusun konumu y eksenınde asagılaradusuyor
				//
			}else {
				gameState=2;//oyunun bitme durumu kus y eksenınde 0dan kucuk oldugunda
			}
